...
<body>
    <div class="login-container">
        ...
        <?php if(session()->getFlashdata('msg_login')):?>
            <div style="background-color: #f8d7da; color: #721c24; padding: 10px; border-radius: 5px; margin-bottom: 20px;">
                <?= session()->getFlashdata('msg_login') ?>
            </div>
        <?php endif;?>
        ...
        <form method="post" action="<?= base_url('login'); ?>">
            <div class="input-group">
                ...
                <input name="email" type="email" id="email" placeholder="Digite seu e-mail" autocomplete="username" required 
                       value="<?= old('email'); ?>"> </div>
        ...
        <div class="login-footer">
            <p><a target="_blank" href="/senha">Esqueceu sua senha?</a></p>
            <p>Novo por aqui? <a href="<?= base_url('cadastro'); ?>">Crie sua conta.</a></p>
        </div>
    </div>
